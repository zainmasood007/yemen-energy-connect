...
const systemTypes = [
  {
    ...
    rangeAr: 'ميزانية تقريبية لنظام منزلي صغير، تتغير حسب الأحمال وساعات التشغيل ونوع البطاريات.',
    rangeEn: 'Approximate budget for a small home system; varies with loads, backup hours and battery type.',
    savingsAr: 'يساعد على خفض الاعتماد على الوقود والمولد وتقليل الفاتورة الشهرية.',
    savingsEn: 'Helps reduce reliance on diesel and generators and lowers monthly energy spending.',
    roiAr: 'يُسترد الاستثمار عادة خلال بضع سنوات حسب نمط الاستهلاك وأسعار الوقود.',
    roiEn: 'Investment is typically recovered over a few years depending on usage pattern and fuel prices.',
    featured: false,
  },
  {
    id: 'home-medium',
    ...
    rangeAr: 'ميزانية تقديرية لمنزل عائلي متوسط، تتحدد بعد دراسة الأحمال وساعات التشغيل ونوع البطاريات.',
    rangeEn: 'Indicative budget for a medium family home, defined after studying loads, backup hours and battery type.',
    savingsAr: 'يوفر جزءاً كبيراً من تكلفة الوقود والمولد مقارنة بالاعتماد الكامل على الشبكة.',
    savingsEn: 'Covers a large share of fuel and generator cost compared to fully relying on the grid.',
    roiAr: 'يساعد على تحقيق وفر تراكمي واضح على المدى المتوسط والبعيد.',
    roiEn: 'Helps achieve clear cumulative savings over the medium and long term.',
    featured: true,
  },
  {
    id: 'shop',
    ...
    rangeAr: 'ميزانية تقريبية لنشاطات تجارية متوسطة، تختلف حسب ساعات العمل اليومية وطبيعة الأحمال.',
    rangeEn: 'Approximate budget for typical commercial activities; varies with daily operating hours and load profile.',
    savingsAr: 'تقلل الاعتماد على المولد في أوقات الذروة وتثبت تكاليف التشغيل.',
    savingsEn: 'Reduces generator dependence during peak hours and stabilizes operating costs.',
    roiAr: 'تحسين التدفق النقدي على المدى المتوسط عبر خفض مصروفات الطاقة الشهرية.',
    roiEn: 'Improves cash flow over the medium term by reducing monthly energy expenses.',
    featured: false,
  },
  {
    id: 'farm',
    ...
    rangeAr: 'ميزانية تقديرية لأنظمة ري ومزارع، تتغير حسب حجم المضخات ومساحة الأرض وعدد ساعات التشغيل.',
    rangeEn: 'Indicative budget for farm and irrigation systems; depends on pump size, land area and operating hours.',
    savingsAr: 'تقلل بشكل كبير من استهلاك وقود الديزل لمضخات الري.',
    savingsEn: 'Significantly reduces diesel consumption for irrigation pumps.',
    roiAr: 'في العادة تحقق وفورات واضحة في تكلفة الوقود خلال فترة تشغيل قصيرة نسبياً.',
    roiEn: 'Typically delivers noticeable fuel savings over a relatively short operating period.',
    featured: false,
  },
  {
    id: 'enterprise',
    ...
    rangeAr: 'يتم تحديد الميزانية من خلال دراسة جدوى مفصلة وحساب الأحمال وخطط التوسع المستقبلية.',
    rangeEn: 'Budget is defined through a detailed feasibility study, load analysis and future expansion plans.',
    savingsAr: 'يهدف إلى خفض تكاليف التشغيل على مستوى المؤسسة وتحسين استقرار الطاقة.',
    savingsEn: 'Aims to reduce organization-wide operating costs and improve energy stability.',
    roiAr: 'العائد يعتمد على طبيعة النشاط وساعات التشغيل، ويتم تقديمه ضمن دراسة جدوى مخصصة.',
    roiEn: 'Return depends on activity type and operating hours and is provided within a custom feasibility study.',
    featured: false,
  },
];
